...
// SQL-файлы вшиваются в бинарник через go:embed, поэтому Docker-образ
// самодостаточен: контейнеру не нужен смонтированный каталог с миграциями,
// он "знает" их сам и применяет при каждом старте (если они ещё не применены).
package migrate
