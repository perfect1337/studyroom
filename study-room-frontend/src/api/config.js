...
export const API = {
  users: import.meta.env.VITE_USERS_API ?? "https://localhost/api/v1",
  academic: import.meta.env.VITE_ACADEMIC_API ?? "https://localhost/api/v1/academic",
  contracts: import.meta.env.VITE_CONTRACTS_API ?? "https://localhost/api/v1/contracts",
  crm: import.meta.env.VITE_CRM_API ?? "https://localhost/api/v1/crm",
  notifications: import.meta.env.VITE_NOTIFICATIONS_API ?? "https://localhost/api/v1/notifications",
};
